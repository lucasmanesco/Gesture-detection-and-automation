...
while (1):
    ...
    try:
        # um erro ocorre se não encontrar nada na janela, pois não
        # pode encontrar o contorno da área máxima portanto
    ...
    # definindo a região de interesse
        for i in range(defects.shape[0]):
            ...
            # ignore ângulos > 90 e ignore pontos muito próximos ao
            # objeto convexo (geralmente vêm devido ao ruído)
